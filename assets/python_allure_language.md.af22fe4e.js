...
<span class="line"><span style="color:#24292E;">    </span><span style="color:#D73A49;">raise</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">Exception</span><span style="color:#24292E;">(</span><span style="color:#032F62;">&#39;oops&#39;</span><span style="color:#24292E;">)</span></span></code></pre></div><h3 id="supported-pytest-features" tabindex="-1">Supported Pytest features <a class="header-anchor" href="#supported-pytest-features" aria-label="Permalink to &quot;Supported Pytest features&quot;">​</a></h3><p>Some of the common Pytest features that the Allure report supports include xfails, fixtures and finalizers, marks, conditional skips and parametrization.</p><h4 id="xfail" tabindex="-1">Xfail <a class="header-anchor" href="#xfail" aria-label="Permalink to &quot;Xfail&quot;">​</a></h4><p>This is pytest way of marking expected failures: (<a href="/python/pytest/how_to_guides/skip_xfail#how-to-use-skip-and-xfail-to-deal-with-tests-that-cannot-succeed">Pytest docs</a>)</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">@pytest.mark.xfail</span><span style="color:#E1E4E8;">(</span><span style="color:#FFAB70;">condition</span><span style="color:#F97583;">=lambda</span><span style="color:#E1E4E8;">: </span><span style="color:#79B8FF;">True</span><span style="color:#E1E4E8;">, </span><span style="color:#FFAB70;">reason</span><span style="color:#F97583;">=</span><span style="color:#9ECBFF;">&#39;this test is expecting failure&#39;</span><span style="color:#E1E4E8;">)</span></span>
...
<span class="line"><span style="color:#24292E;">    simple_step(param2)</span></span></code></pre></div><p>Example of captured test invocations with different sets of named and unnamed parameters.</p><p><img src="`+c+'" alt="pytest_parameterized_tests"></p><p>Details of test execution for a parameterized test with a named parameter.</p><p><img src="'+i+`" alt="pytest_parameterized_with_id"></p><h3 id="allure-features" tabindex="-1">Allure Features <a class="header-anchor" href="#allure-features" aria-label="Permalink to &quot;Allure Features&quot;">​</a></h3><p>Allure currently supports almost every available feature except for environment with Pytest.</p><h4 id="steps" tabindex="-1">Steps <a class="header-anchor" href="#steps" aria-label="Permalink to &quot;Steps&quot;">​</a></h4><p>The first and probably most important aspect of the Allure report is that it allows to get a very detailed step-by-step representation of every test invocation. This is made possible with <code>@allure.step</code> decorator that adds invocation of the annotated method or function with provided arguments to the report.</p><p>Methods annotated with <code>@step</code> can be stored aside from your tests and just imported when needed. Step methods can have an arbitrarily deep nested structure.</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> allure</span></span>
<span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> pytest</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:#24292E;">================================ </span><span style="color:#005CC5;">3</span><span style="color:#24292E;"> </span><span style="color:#032F62;">passed</span><span style="color:#24292E;"> </span><span style="color:#032F62;">in</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">0.01</span><span style="color:#24292E;"> </span><span style="color:#032F62;">seconds</span><span style="color:#24292E;"> </span><span style="color:#032F62;">============================</span></span></code></pre></div><h2 id="behave" tabindex="-1">Behave <a class="header-anchor" href="#behave" aria-label="Permalink to &quot;Behave&quot;">​</a></h2><p>Allure integrates with behave as an external formatter.</p><h3 id="instalation" tabindex="-1">Instalation <a class="header-anchor" href="#instalation" aria-label="Permalink to &quot;Instalation&quot;">​</a></h3><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">$</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">pip</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">install</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">allure-behave</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">$</span><span style="color:#24292E;"> </span><span style="color:#032F62;">pip</span><span style="color:#24292E;"> </span><span style="color:#032F62;">install</span><span style="color:#24292E;"> </span><span style="color:#032F62;">allure-behave</span></span></code></pre></div><h3 id="usage-1" tabindex="-1">Usage <a class="header-anchor" href="#usage-1" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><p>You can specify the formatter directly in the command line:</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">$</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">behave</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">-f</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">allure_behave.formatter:AllureFormatter</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">-o</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">%allure_result_folder%</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">./features</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">$</span><span style="color:#24292E;"> </span><span style="color:#032F62;">behave</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-f</span><span style="color:#24292E;"> </span><span style="color:#032F62;">allure_behave.formatter:AllureFormatter</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-o</span><span style="color:#24292E;"> </span><span style="color:#032F62;">%allure_result_folder%</span><span style="color:#24292E;"> </span><span style="color:#032F62;">./features</span></span></code></pre></div><h3 id="features" tabindex="-1">Features <a class="header-anchor" href="#features" aria-label="Permalink to &quot;Features&quot;">​</a></h3><h4 id="severity" tabindex="-1">Severity <a class="header-anchor" href="#severity" aria-label="Permalink to &quot;Severity&quot;">​</a></h4><p>Tags that are matched to severity names (like critical, trivial, etc.) will be interpreted as a feature or scenario severity. Scenario inherits feature severity if not provided, or overrides it in the other case. If there is more than one severity definition tag, only the last one is used.</p><h4 id="steps-and-scenarious-status" tabindex="-1">Steps and Scenarious status <a class="header-anchor" href="#steps-and-scenarious-status" aria-label="Permalink to &quot;Steps and Scenarious status&quot;">​</a></h4><p>Steps with assertion exceptions will be marked as failed. Other exceptions thrown during the test execution will cause it to have status broken. Scenario status will be determined by the first unsuccessful step status. When all steps are passed, then the whole scenario is considered passed.</p><h4 id="step-data" tabindex="-1">Step Data <a class="header-anchor" href="#step-data" aria-label="Permalink to &quot;Step Data&quot;">​</a></h4><p>Step data text or table data are represented as step attachments in report.</p><h2 id="nose" tabindex="-1">Nose <a class="header-anchor" href="#nose" aria-label="Permalink to &quot;Nose&quot;">​</a></h2><p>It is a port of <a href="https://github.com/allure-framework/allure-python" target="_blank" rel="noreferrer">pytest-allure-adaptor</a> for <a href="https://github.com/nose-devs/nose" target="_blank" rel="noreferrer">nose framework</a>.</p><h3 id="usage-2" tabindex="-1">Usage <a class="header-anchor" href="#usage-2" aria-label="Permalink to &quot;Usage&quot;">​</a></h3><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">nosetests</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--with-allure</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--logdir=/path/to/put/results</span></span>
...
<span class="line"><span style="color:#24292E;">    </span><span style="color:#D73A49;">assert</span><span style="color:#24292E;"> make_some_data_bar() </span><span style="color:#D73A49;">is</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">not</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">None</span></span></code></pre></div><h4 id="environment" tabindex="-1">Environment <a class="header-anchor" href="#environment" aria-label="Permalink to &quot;Environment&quot;">​</a></h4><p>You can provide test <a href="https://github.com/allure-framework/allure-core/wiki/Environment" target="_blank" rel="noreferrer">environment parameters</a> such as report name, browser or test server address to allure test report.</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> nose</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">    nose.allure.environment(</span><span style="color:#E36209;">report</span><span style="color:#D73A49;">=</span><span style="color:#032F62;">&#39;Allure report&#39;</span><span style="color:#24292E;">, </span><span style="color:#E36209;">browser</span><span style="color:#D73A49;">=</span><span style="color:#D73A49;">u</span><span style="color:#032F62;">&#39;Firefox&#39;</span><span style="color:#24292E;">)</span></span></code></pre></div><h4 id="severity-1" tabindex="-1">Severity <a class="header-anchor" href="#severity-1" aria-label="Permalink to &quot;Severity&quot;">​</a></h4><p>Any test, class or module can be marked with different severity:</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> nose</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#D73A49;">def</span><span style="color:#24292E;"> </span><span style="color:#6F42C1;">test_foo</span><span style="color:#24292E;">():</span></span>
<span class="line"><span style="color:#24292E;">    </span><span style="color:#D73A49;">assert</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">False</span></span></code></pre></div><h4 id="features-stories" tabindex="-1">Features &amp; Stories <a class="header-anchor" href="#features-stories" aria-label="Permalink to &quot;Features &amp; Stories&quot;">​</a></h4><p>Feature and Story can be set for test.</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> nose</span></span>
<span class="line"></span>
